...
#include "cdownloadtofilereply.h"
#include <QDebug>


CDownloadToFileReply::CDownloadToFileReply(
        const CDownloadToFileRequest &request, QNetworkAccessManager *network,
        QObject *parent) : CAbstractDownloadReply(network, parent)
{
    m_request = request;
...
void CDownloadToFileReply::processData()
{
