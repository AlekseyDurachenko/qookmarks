...
CDownloadWebPageInfoReply::CDownloadWebPageInfoReply(
        const CDownloadWebPageInfoRequest &request,
...
void CDownloadWebPageInfoReply::parseHtml(xmlNode *root, const xmlChar *prev)
{
