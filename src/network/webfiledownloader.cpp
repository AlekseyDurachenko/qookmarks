...
WebFileDownloader::WebFileDownloader(QNetworkAccessManager *network,
...
void WebFileDownloader::setUrl(const QUrl &url)
{
    m_url = url;
}

void WebFileDownloader::setFileName(const QString &fileName)
{
    m_fileName = fileName;
}

void WebFileDownloader::start()
{
    if (isStarted())
        return;
...
void WebFileDownloader::reply_readyRead()
{
...
void WebFileDownloader::reply_finished()
{
    m_isFinished = true;
    m_isStarted = false;
